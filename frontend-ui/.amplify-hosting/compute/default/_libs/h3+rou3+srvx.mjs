...
/%(?:25)*(?:2f|5c)/i.source;
//#endregion
export { toEventHandler as a, toNodeHandler as c, defineLazyEventHandler as i, FastURL as l, HTTPError as n, toRequest as o, defineHandler as r, NodeResponse as s, H3Core as t };
